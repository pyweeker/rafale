...
# Constants
SCREEN_WIDTH = 900 #1800 #1000
SCREEN_HEIGHT = 900 #1000 #650
SCREEN_TITLE = "Rafale"
...
class GameView(arcade.View):
    ...
    def on_show(self):
        ...
        print(f" self.window.__dict__   {self.window.__dict__}")
    ...
    def update(self, delta_time):
        ...
        move_x, move_y, move_angle = get_joy_position(joy_dico.move_stick_x, joy_dico.move_stick_y)
